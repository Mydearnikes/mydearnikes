...
const HeroSection = () => {
  ...
  const heroSlides: HeroSlide[] = [
    {
      id: 1,
      bgImage: "/images/newHeroFeb.webp",
      productImage: "/images/I_love4.webp",
      productName: "I <3 my super hot gf",
      productPrice: "₹999",
      productLink: "/product/unisex-oversized-classic-t-shirt-129",
    },
    {
      id: 2,
      bgImage: "/images/wishICared.webp",
      productImage: "/images/wishIProduct.webp",
      productName: "I wish I cared",
      productPrice: "₹599",
      productLink: "/product/baby-tee-65",
    },
    {
      id: 3,
      bgImage: "/images/kimK.webp",
      productImage: "/images/kim.webp",
      productName: "KIM K",
      productPrice: "₹299",
      productLink: "/product/kim-k-sextape-lighter",
    },
  ];
  ...
  return (
    <>
          ...
          <div className="buttonBox flex flex-col h-[80vh] justify-end items-center pt-4">
            <Link href="/category/all-products" className="pointer-events-auto">
              <button
                ...
                style={{
                  animation:
                    "fadeInUp 0.8s cubic-bezier(0.4, 0, 0.2, 1) 0.4s both",
                }}
              >
                Shop Now
              </button>
      ...
      <div className="hidden lg:flex gap-[8px] pt-15 ">
        ...
        <div
          className="w-[40vw] h-[94vh] px-[8px] mt-4 animate-fadeIn"
          ...
          <div className="h-[27vh] flex flex-col justify-end">
            <div className="headingAndCta flex justify-between items-end">
              <div
                ...
                style={{
                  animation:
                    "fadeInUp 0.8s cubic-bezier(0.4, 0, 0.2, 1) 0.3s both",
                }}
              >
                <p>NOT FOR</p>
                <p>EVERYONE</p>
