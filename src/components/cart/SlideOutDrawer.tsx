...
//                           Free express shipping. Duties and taxes will be
...
const CartDrawer = ({ isOpen, onClose }: CartDrawerProps) => {
  ...
  const handleShopifyCheckout = async () => {
    ...
    try {
      ...
      // Don't clear cart - keep items in local cart
              ...
              {items.length === 0 ? (
                ...
                <>
                  ...
                  >
                    ...
                    {/* Cart Summary */}
                    <div className="p-4 bg-gray-50 lg:mb-3 mb-10">
                      <div className="space-y-2 mb-4">
                        <div className="flex justify-between text-sm">
                          <span>Subtotal</span>
                          <span>{formatPrice(getTotalPrice())}</span>
        ...
        {showClearConfirm && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg p-6 shadow-xl z-[70] w-[90%] max-w-sm"
            >
